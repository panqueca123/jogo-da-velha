...
function marcarCasa(nomeBotao){
    ...
    if(jogada % 2 == 0){
        ...
        document.getElementById(nomeBotao).style.color = "Violet"
    }else{
        document.getElementById(nomeBotao).innerText = "O"
        document.getElementById(nomeBotao).style.color = "BurlyWood"
    }
...
function verificaLinhasXColunas(posL1, posL2, posL3, posC1, posC2, posC3){
    if(document.getElementById("bt" + posL1 + "" + posC1).innerText == document.getElementById("bt" +posL2 + "" + posC2).innerText
        ...
        for(let cont in tabuleiro){ //Pinta a linha ou coluna vencedora de vermelho
            (posC1 == 0 &&  posC2 == 1 &&  posC3 == 2) ? document.getElementById("bt" + posL1 + "" + cont).style.color = "Indigo" :
            document.getElementById("bt" + cont + "" + posC1).style.color = "MediumSlateBlue";
            vencedor++
        }
    }}
...
function verificaDiagonais(pos1, pos2, pos3){
    ...
    if((diagonal[0] == "X" && diagonal[1] == "X" && diagonal[2] == "X")
        ...
        for(let cont in tabuleiro){
            (pos3 == "bt22") ? document.getElementById("bt" + cont + "" + cont).style.color = "MediumSlateBlue" :
            document.getElementById("bt" + cont + "" + contRegressivo--).style.color = "MediumSlateBlue" //Pinta a diagonal principal ou secundária vencedora de vermelho
            vencedor++
        }
    }
}
